                ...
                completionBlock:(CompletedPostViewConference) onCompleted
{
    ...
    if (input.conferencesid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'conferencesid' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    [_queryBuilder appendString: @"/conferences/viewconference.{ResponseType}"];
                ...
                completionBlock:(CompletedPostDeafMuteParticipant) onCompleted
{
    ...
    if (input.conferenceSid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'conferenceSid' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.participantSid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'participantSid' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.responseType == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'responseType' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/deafMuteParticipant.{ResponseType}"];
                ...
                completionBlock:(CompletedPostViewParticipant) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/viewparticipant.{ResponseType}"];
                ...
                completionBlock:(CompletedPostListParticipant) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/listparticipant.{ResponseType}"];
                ...
                completionBlock:(CompletedPostAddParticipant) onCompleted
{
    ...
    if (input.conferencesid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'conferencesid' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.participantnumber == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'participantnumber' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.responseType == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'responseType' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/addParticipant.{ResponseType}"];
                ...
                completionBlock:(CompletedPostListConference) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/listconference.{ResponseType}"];
